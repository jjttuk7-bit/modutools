...
addRoute('/', '모두의 도구 · 가입 없이 바로 쓰는 무료 실무 도구', '사장님과 프리랜서를 위한 25가지 무료 실무 도구를 한 곳에서 제공합니다.', [
...
addRoute('/guide', '25가지 무료 업무 도구 사용 가이드', '모두의 도구에 포함된 25가지 무료 도구의 사용 상황, 예시, 주의사항을 정리했습니다.', [
